...
mysqli_query($conn, "UPDATE ".$_POST['database']." SET plasmid_name = '".$_POST['plasmid_name']."', sequence = '".$_POST['sequence']."', savvy_markers = '".$_POST['markers']."', savvy_enzymes='".$_POST['enzymes']."' checksum = '".$checksum."' WHERE plasmid_id = ".$_POST['plasmid_id'].";") or die("There was a database error.<br />".mysqli_error($conn));
